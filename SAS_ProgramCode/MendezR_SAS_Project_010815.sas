...
DATE: Thursday, January 08, 2015     TIME: 11:01:33 AM
PROJECT: MendezR_SAS_Project_010715
PROJECT PATH: P:\QAC\qac200\students\rmendez\Assignments\MendezR_SAS_Project_010715.egp
---------------------------------------- */

/* Library assignment for Local.HW_2 */
Libname HW_2 V9 'P:\QAC\qac200\Data\MEPS' ;
...
/*   START OF NODE: Assign Project Library (HW_2)   */
%LET _CLIENTTASKLABEL='Assign Project Library (HW_2)';
%LET _CLIENTPROJECTPATH='P:\QAC\qac200\students\rmendez\Assignments\MendezR_SAS_Project_010715.egp';
%LET _CLIENTPROJECTNAME='MendezR_SAS_Project_010715.egp';

GOPTIONS ACCESSIBLE;
LIBNAME HW_2  "P:\QAC\qac200\Data\MEPS" ;
...
GOPTIONS ACCESSIBLE;
%_eg_conditional_dropds(WORK.FILTER_FOR_MEPS_FULLYR_18);

PROC SQL;
   CREATE TABLE WORK.FILTER_FOR_MEPS_FULLYR_18 AS 
   SELECT t1.DUPERSID, 
          t1.AGE12X, 
          t1.SEX, 
          t1.REGION12, 
...
/*   START OF NODE: SAS ProgramCode   */
%LET SYSLAST=WORK.FILTER_FOR_MEPS_FULLYR_18;
%LET _CLIENTTASKLABEL='SAS ProgramCode';
%LET _CLIENTPROJECTPATH='P:\QAC\qac200\students\rmendez\Assignments\MendezR_SAS_Project_010715.egp';
%LET _CLIENTPROJECTNAME='MendezR_SAS_Project_010715.egp';
%LET _SASPROGRAMFILE='P:\QAC\qac200\students\rmendez\Assignments\SAS_ProgramCode\SAS ProgramCode.sas';
...
/* -------------------------------------------------------------------
   ...
   Generated on: Thursday, January 08, 2015 at 9:48:35 AM
   By task: Data Set Attributes1

   Input Data: Local:WORK.FILTER_FOR_MEPS_FULLYR_18
   Server:  Local
   ------------------------------------------------------------------- */
...
PROC DATASETS NOLIST NODETAILS; 
   CONTENTS DATA=WORK.FILTER_FOR_MEPS_FULLYR_18 ;
...
/* -------------------------------------------------------------------
   ...
   Generated on: Thursday, January 08, 2015 at 11:00:09 AM
   By task: Data Set Attributes

   Input Data: Local:HW_2.MEPS_FULLYR_2012
   Server:  Local
   ------------------------------------------------------------------- */
...
PROC DATASETS NOLIST NODETAILS; 
   CONTENTS DATA=HW_2.MEPS_FULLYR_2012 OUT=WORK.SUCOUT1;
