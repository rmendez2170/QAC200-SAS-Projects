...
DATE: Thursday, January 08, 2015     TIME: 9:21:51 AM
...
/* -------------------------------------------------------------------
   ...
   Generated on: Thursday, January 08, 2015 at 9:20:36 AM
...
PROC DATASETS NOLIST NODETAILS; 
   CONTENTS DATA=WORK.FILTER_FOR_MEPS_FULLYR_18 OUT=WORK.SUCOUT1;

RUN;

DATA WORK.CONTContentsForFILTER_FOR_MEPS_F(LABEL="Contents Details for FILTER_FOR_MEPS_FULLYR_18");
   SET WORK.SUCOUT1;
RUN;
...
CREATE TABLE WORK.SCTABLE AS
	SELECT * FROM WORK.SCVIEW
		WHERE memname='FILTER_FOR_MEPS_FULLYR_18';
QUIT;
...
/* -------------------------------------------------------------------
   ...
   Generated on: Thursday, January 08, 2015 at 9:20:37 AM
